...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                              KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, OSL(_ACCENTS),
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, LCTL(LSFT(KC_M)),   KC_HOME, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, 
                    KC_LGUI, KC_LALT, MO(2), LT(4,KC_NO),                KC_SPC, MO(3), KC_NO, KC_RGUI
),
[_ACCENTS] = LAYOUT(
...
[_FN] = LAYOUT(
    ...
    KC_NO, SGUI(KC_LEFT), LGUI(KC_LEFT), LGUI(KC_DOWN), LGUI(KC_RGHT), SGUI(KC_RGHT),              KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, 
    KC_NO, LGUI(LCTL(KC_LEFT)), LGUI(KC_TAB), LGUI(LCTL(KC_RIGHT)), KC_NO, KC_NO,          KC_END, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 

...
[_ACCENTS] = LAYOUT(
    ...
    KC_NO, ACC_AGRV, KC_NO, KC_NO,    KC_NO, KC_NO,                      KC_NO, ACC_UTRM, ACC_ITRM, ACC_OTRM, KC_NO, KC_TRNS,
...
[_FN] = LAYOUT(
    ...
    KC_NO,       CW_LEFT,       LGUI(KC_TAB),  CW_RIGHT,      KC_NO,         KC_NO,                KC_END, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, 
